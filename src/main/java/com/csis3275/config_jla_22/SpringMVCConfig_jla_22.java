...
public class SpringMVCConfig_jla_22 extends WebMvcConfigurationSupport {
	...
	// This is simply to allow any file requests past static to go through to the "/static"folder,we can dd things	like images	css etc..
